#include <Canhao.hpp>
        ...
        Entidades::Obstaculos::Canhao::Canhao( float alt, float larg,const sf::Vector2f posicao): Entidades::Obstaculos::Obstaculo(sf::Vector2f(larg, alt), posicao, false), lancamentos(0)//,listaBolasCanhao(){
         {        it=0;
